...
Route::get('/student',[AdminController::class,'studentList'])->name('studentList');
Route::get('/studentDashboard',[AdminController::class,'studentDashboard'])->name('studentDashboard');
